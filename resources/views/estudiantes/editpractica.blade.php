...
<div id="pagina">
    <div id="formulario">
        ...
        <form method="post" action="{{route('estudiantes.update', $practica->pp_id)}}" role="form" class="form" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="pp_asesorempresa" id="pp_asesorempresa" placeholder="" required value="{{ $practica->pp_asesorempresa }}">
            </div>
            <div class="form-row">
