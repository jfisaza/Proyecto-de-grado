                    ...
                    <div class="">
                        ...
                        <section class="tablas">
                            <article id="article">
                                ...
                                <a href="{{ route('usuarios.edit', auth()->user()->id) }}" class="btn btn-sm btn-success mt-3 mb-3 ml-3" title="Editar Datos"><span class="fas fa-user-edit"></span></a>
                                ...
                                <a href="{{ route('docentes.index') }}" class="btn btn-sm btn-success" title="Docente"><span class="fas fa-arrow-right"></span></a>
                                @endif
                                @if(auth()->user()->hasRole('administrativo'))
                                <a href="{{ route('administrativos.index') }}" class="btn btn-sm btn-success" title="Administrador"><span class="fas fa-arrow-right"></span></a>
                                @endif
                            </article>
                        </section>
