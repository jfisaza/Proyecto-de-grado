...
<article class="logo"height="70px" width="110px">
    ...
    <div id="pagina">
        <div id="formulario">
            ...
            <form method="POST" action="{{action('BancoController@updateSolicitud',$solicitud->sol_id)}}" role="form" class="form">
            {{ csrf_field()}}

                <div class="form-group">
                    <label for="sol_pro_id"></label>
                    <select id="sol_pro_id" name="sol_pro_id" class="form-control" required>
                        <option value="{{ $solicitud->sol_pro_id }}" selected>{{ $solicitud->programa->pro_nombre }}</option>
                ...
                <div class="form-group">
                    ...
                    <select id="sol_emp_id" name="sol_emp_id" class="form-control" required>
                        <option value="{{ $solicitud->sol_emp_id }}" selected>{{ $solicitud->empresa->emp_nombre }}</option>
