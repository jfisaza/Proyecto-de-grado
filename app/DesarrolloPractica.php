...
class DesarrolloPractica extends Model
{
    ...
    protected $fillable = ['dp_titulo','dp_usu_id','dp_emp_id','dp_numconvenio',
    'dp_fechaconvenio','dp_dir_usu_id','dp_pro_id','dp_pp_id','dp_con_id','dp_formato','dp_fecha_entrega',
    ...
    public function programas(){
        return $this->belongsTo(Programas::class,'dp_pro_id');
    }
    public function estudiante(){
        return $this->belongsTo(User::class, 'dp_usu_id');
    }
